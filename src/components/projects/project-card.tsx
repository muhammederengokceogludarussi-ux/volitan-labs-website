...
export function ProjectCard({
  ...
  return (
    <div
      className={cn(
        "group relative rounded-xl border border-border/30 bg-surface p-5 transition-all duration-300 hover:border-accent-cyan/30 hover:shadow-lg hover-glow",
      ...
      <div className="mt-5 flex items-center gap-3">
        ...
        {github && (
          <a
            ...
            className="flex h-8 w-8 items-center justify-center rounded-lg text-text-muted transition-colors hover:text-text-primary hover:bg-surface-elevated"
            aria-label="GitHub"
          >
